...
Original file is located at
    https://colab.research.google.com/drive/1XhqWY9f0HuSv-HjNfJnFfxUkBCDoRTIX
"""
...
def save_model(model, filepath):
    ...
    model.save_weights(filepath + '.weights.h5')  # Adjust the filename format here
    with open(filepath + '.json', 'w') as f:  # Save model config separately
...
def load_model(filepath):
    ...
    model.load_weights(filepath + '.weights.h5')  # Corrected file path
    return model

save_model(model, 'model_config.json')
