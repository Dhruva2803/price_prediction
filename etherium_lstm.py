...
Original file is located at
    https://colab.research.google.com/drive/141hHrRCsnhWinKOmJ5iFmUdIoJMVCxu9
"""
...
fig.add_trace(go.Bar(
    x=monthvise.index,
    y=monthvise['Open'],
    name='Etherium Open Price',
    marker_color='crimson'
))
fig.add_trace(go.Bar(
    x=monthvise.index,
    y=monthvise['Close'],
    name='Etherium Close Price',
    marker_color='lightsalmon'
))

fig.update_layout(barmode='group', xaxis_tickangle=-45,
                  title='Monthwise comparision between Etherium open and close price')
fig.show()

y_2017.groupby(y_2017['Date'].dt.strftime('%B'))['Low'].min()
monthwise_high = y_2017.groupby(df['Date'].dt.strftime('%B'))['High'].max()
...
fig.add_trace(go.Bar(
    ...
    y=monthwise_high,
    name='Etherium high Price',
    marker_color='rgb(0, 153, 204)'
))
fig.add_trace(go.Bar(
    x=monthwise_low.index,
    y=monthwise_low,
    name='Etherium low Price',
    marker_color='rgb(255, 128, 0)'
))

fig.update_layout(barmode='group',
                  title=' Monthwise High and Low Etherium price')
fig.show()

names = cycle(['Etherium Open Price','Etherium Close Price','Etherium High Price','Etherium Low Price'])

fig = px.line(y_2017, x=y_2017.Date, y=[y_2017['Open'], y_2017['Close'],
                                          y_2017['High'], y_2017['Low']],
             labels={'Date': 'Date','value':'Etherium value'})
fig.update_layout(title_text='Etherium analysis chart', font_size=15, font_color='black',legend_title_text='Etherium Parameters')
...
y_overall = df.loc[(df['Date'] >= '2017-11-09')
                     & (df['Date'] <= '2024-02-01')]
...
Here we are just considering 1.5 year data for training data
...
# reshape input to be [samples, time stams, features] which is required for LSTM
